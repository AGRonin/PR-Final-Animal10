...
def build_balanced_subset(dataset, num_per_class=50):
...
def data_load(root):
    ...
    train_dataset = build_balanced_subset(train_dataset, num_per_class=200)
...
def main():
    ...
    trained_model, list_train_acc, list_val_acc, list_train_loss = train_net(model, 0.1, 2, train_loader, val_loader)
    print("训练结束!\n")
